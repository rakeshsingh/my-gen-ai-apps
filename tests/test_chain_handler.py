...
from helpers import chain_handler
...
class TestChainHandler(unittest.TestCase):
    ...
    def test_format_docs_single_doc(self):
        ...
        result = chain_handler.format_docs(single_doc)
        self.assertEqual(result, "Single document content")

    @patch('helpers.chain_handler.create_react_agent')
    @patch('helpers.chain_handler.InMemorySaver')
    @patch('helpers.chain_handler.ChatPromptTemplate')
    @patch('helpers.chain_handler.init_chat_model')
    ...
    def test_setup_agent(self, mock_tools, mock_init_chat_model, mock_prompt_template, 
        ...
        result = chain_handler.setup_agent("ollama", "llama3.2")
    ...
    @patch('helpers.chain_handler.create_retrieval_chain')
    @patch('helpers.chain_handler.create_stuff_documents_chain')
    @patch('helpers.chain_handler.ChatPromptTemplate')
    @patch('helpers.chain_handler.ChatOllama')
    def test_setup_chain(self, mock_chat_ollama, mock_prompt_template, 
        ...
        result = chain_handler.setup_chain(self.test_model, self.test_retriever)
    ...
    @patch('helpers.chain_handler.create_retrieval_chain')
    @patch('helpers.chain_handler.create_stuff_documents_chain')
    @patch('helpers.chain_handler.create_history_aware_retriever')
    @patch('helpers.chain_handler.ChatPromptTemplate')
    @patch('helpers.chain_handler.ChatOllama')
    def test_setup_chain_chatbot(self, mock_chat_ollama, mock_prompt_template,
        ...
        result = chain_handler.setup_chain_chatbot(self.test_model, self.test_retriever)
    ...
    def test_setup_chain_custom_context_size(self, mock_chat_ollama):
        ...
        with patch('helpers.chain_handler.ChatPromptTemplate'), \
             patch('helpers.chain_handler.create_stuff_documents_chain'), \
             patch('helpers.chain_handler.create_retrieval_chain'):
            
            chain_handler.setup_chain(self.test_model, self.test_retriever, context_size=4096)
